<div class="d-flex align-items-center logo-box justify-content-start">
    ...
    <a href="index.html" class="logo">
          <!-- logo-->
          <div class="logo-lg">
              <span class="light-logo"><img src="{{ url('') }}/assets/images/logo-bbn.png" alt="logo"></span>
              <span class="dark-logo"><img src="{{ url('') }}/assets/images/logo-bbn-text.png" alt="logo"></span>
          </div>
    </a>    
</div>  
<!-- Header Navbar -->
