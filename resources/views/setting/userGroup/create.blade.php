                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input name="kode" type="text" class="form-control ps-15 bg-transparent" placeholder="User Group Code">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label class="form-label">User Group Name<span style="color: red">*</span></label>
                                    <input name="nama" type="text" class="form-control ps-15 bg-transparent" placeholder="User Group Name">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label class="form-label">Created By<span style="color: red">*</span></label>
                                    <input type="text" class="form-control ps-15" value="{{ Auth::user()->name }}" readonly>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label class="form-label">Created Date<span style="color: red">*</span></label>
                                    <input type="text" class="form-control ps-15" value="{{ Now() }}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-3">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        @foreach (\App\Models\PrivilegesModel::where('m_module_id', $priv->m_module_id )->get() as $priv_code)
                                            <div class="controls">
                                                <fieldset>
                                                    <input type="checkbox" name="m_privilege_id[]" id="checkbox_{{ $priv_code->id }}" value="{{ $priv_code->id }}">
