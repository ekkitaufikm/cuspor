                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input name="kode" type="text" class="form-control ps-15" value="{{ $role->kode }}">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    <label class="form-label">User Group Name<span style="color: red">*</span></label>
                                    <input name="nama" type="text" class="form-control ps-15" value="{{ $role->nama }}">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach (\App\Models\PrivilegesModel::where('m_module_id', $priv->m_module_id )->get() as $priv_code)
                                            <div class="controls">
                                                <fieldset>
                                                    @php
                                                        // Cek apakah ID ini termasuk dalam daftar privilege yang dipilih
                                                        $isChecked = in_array($priv_code->id, $selected_privileges);
                                                    @endphp
                                                    <input type="checkbox" name="m_privilege_id[]" id="checkbox_{{ $priv_code->id }}" value="{{ $priv_code->id }}" {{ $isChecked ? 'checked' : '' }}>
