    ...
    <div class="row">
        ...
        <div class="col-12">
            <div class="box">
                ...
                <div class="box-body">
                    <form id="form-id" action="{{ route('company.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-4">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input name="website" type="text" class="form-control ps-15 bg-transparent" placeholder="Company Website">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label class="form-label">Company Email</label>
                                    <input name="email" type="text" class="form-control ps-15 bg-transparent" placeholder="Company Email">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label class="form-label">Company Telephone</label>
                                    <input name="telephone" type="text" class="form-control ps-15 bg-transparent" placeholder="Company Telephone">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group">
                                    <label class="form-label">Company Address</label>
                                    <textarea rows="5" class="form-control" name="address" placeholder="Company Address"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
