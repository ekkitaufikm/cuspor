                ...
                success: function(response) {
                    ...
                    response.quotation_items.forEach((quotation_item, index) => {
                        let row = `<tr>
                                    ...
                                    <td>${rupiah(quotation_item.unit_price)}</td>
                                    <td>${rupiah(quotation_item.amount)}</td>
                                    <td>${quotation_item.weight_per_item}</td>
                                    <td>${quotation_item.weight_total}</td>
                                    <td>${quotation_item.level}</td>
                                </tr>`;
