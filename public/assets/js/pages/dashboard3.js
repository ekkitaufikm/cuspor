...
$(function () {
 ...
 /* jQueryKnob */
    ...
    var options = {
        ...
        var chart = new ApexCharts(document.querySelector("#selling_chart"), options);
        chart.render();
        ...
        var chart = new ApexCharts(document.querySelector("#sold-chart"), options);
        chart.render();
